...
export function ExternalLinkIcon() {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" aria-hidden="true">
            <path d="M6.5 3H3.5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.5 2.5H13.5V6.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M13 3 7 9" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}
